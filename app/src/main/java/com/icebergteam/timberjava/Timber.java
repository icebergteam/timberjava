...
public final class Timber {
    ...
    abstract public static class DebugTree extends Tree {
         ...
         * @param element staktrace element
         ...
         * {@link #println(int, String, String) Log.println()} or
         * {@link #wtf(String, String) Log.wtf()} for logging.
         * <p>
         * {@inheritDoc}
         */

        protected abstract void wtf(String tag, @NotNull String message);

        protected abstract void println(int priority, String tag, @NotNull String message);
